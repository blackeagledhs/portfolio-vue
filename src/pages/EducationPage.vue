<template>
    <main class="responsive-container">
        ...
        <section class="education">
            <EducationCard v-for="(edu, index) in educationList" :key="index" :education="edu"
                @show-modal="openModal" />
        </section>
        <EducationModal :education="selectedEducation" :visible="isModalVisible" @close="closeModal" />
    </main>
</template>
